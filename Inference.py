...
CKPT_PATH    = '/home/kishan/Theis/checkpoint_face_latents/ckpt_epoch_0095.pt' #CKPT path
...
if __name__ == "__main__":
    ...
    # Save a single image (no grid)
    r = torch.randint(2001, 3000, (1,)).item()  # Random seed for filename uniqueness
    print(r)
    save_path = f"{OUTPUT_DIR}/generated_sample_{r}.png"
    vutils.save_image(final_image, save_path)
